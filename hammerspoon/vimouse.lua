...
--    vimouse({'shift', 'cmd'}, 'h')
--
-- This sets shift-cmd-h as the key that toggles Vi Mouse.
--
-- j/k/i/l moves the mouse cursor by 20 pixels.  Holding shift moves by 100
...
-- mouse events.
--
-- <c-d> and <c-u> sends the scroll wheel event.  Holding the keys will speed
-- up the scrolling.
--
